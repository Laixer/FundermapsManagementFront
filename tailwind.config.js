...
export default {
  content: ['./index.html', './src/**/*.{vue,js,ts,jsx,tsx,svg,html}'], // content: ["./src/index.html", "./src/**/*.{html,svg,mdx,js,ts}"],
  theme: {
    fontSize: {
      tag: [
        '0.6875rem',
    ...
    colors: {
      ...
      green: {
        50: '#ecfdf5', // flowbite default
        100: '#e9faf3',
        200: '#afecd4',
        300: '#6ee7b7', // flowbite default
        400: '#34d399', // flowbite default
        500: '#28cc8b',
        700: '#149d67', // flowbite default
        800: '#065f46', // flowbite default
      },
      grey: {
        100: '#f6f7f8',
        200: '#e8eaf1',
      ...
      red: {
        50: '#fef2f2', // flowbite default
        200: '#fecaca', // flowbite default
        400: '#f87171', // flowbite default
        500: '#ed1c24',
        800: '#991b1b', // flowbite default
      },
      yellow: {
        100: '#fffaf0',
        500: '#ffcc69',
